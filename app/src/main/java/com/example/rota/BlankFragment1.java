...
public class BlankFragment1 extends Fragment {
    ...
    TextView Joptext;
    TextView Gendertext;
    TextView favoriteteamtext;
    TextView favoritefoodtext;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        favoriteteamtext = view.findViewById(R.id.favoriteteamtext);
        favoritefoodtext = view.findViewById(R.id.favoritefoodtext);
        Joptext =view.findViewById(R.id.Joptext);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                favoriteteamtext.setText(users.getfavoriteteam());
                favoritefoodtext.setText(users.getfavoritefood());
                Joptext.setText(users.getJop());
